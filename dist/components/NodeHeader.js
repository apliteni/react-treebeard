...
var NodeHeader = /*#__PURE__*/function (_PureComponent) {
  _inherits(NodeHeader, _PureComponent);
    ...
    value: function render() {
      ...
      if (active) {
        styles = Object.assign(style, {
          container: _objectSpread(_objectSpread({}, style.link), style.activeLink)
        });
      } else {
        styles = style;
      }

      return /*#__PURE__*/_react["default"].createElement(decorators.Container, {
